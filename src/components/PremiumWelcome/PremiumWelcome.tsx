...
export default function PremiumWelcome() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#030303] flex items-center justify-center overflow-hidden selection:bg-white/10 font-sans perspective-[1200px]">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 flex items-center justify-center">
        ...
        <motion.div
          className="absolute top-[20%] left-[15%] w-24 h-24 rounded-2xl backdrop-blur-xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent"
          style={{ x: cube1X, y: cube1Y, boxShadow: "0 20px 40px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.2)" }}
        ...
        <motion.div
          className="absolute bottom-[25%] right-[15%] w-32 h-32 rounded-3xl backdrop-blur-xl border border-white/10 bg-gradient-to-tr from-white/5 to-transparent"
          style={{ x: cube2X, y: cube2Y, boxShadow: "0 20px 40px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.1)" }}
      ...
      >
        ...
        >
          <div className="flex items-center gap-3 px-5 py-2 rounded-full border border-white/10 bg-white/[0.03] backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
            <Sparkles className="w-4 h-4 text-blue-400" />
            <span className="text-white/80 text-[11px] font-mono uppercase tracking-[0.3em] pt-0.5">
              Portfolio
            </span>
          </div>
        </motion.div>
        ...
        <div className="flex flex-col items-center text-center w-full" style={{ transformStyle: "preserve-3d" }}>
          <motion.div style={{ transform: "translateZ(120px)" }}>
            <motion.h1
              ...
              className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white/90 to-white/30 drop-shadow-2xl pb-2"
            >
              Konda Balaji
            </motion.h1>
          </motion.div>
          ...
          >
            <h2 className="text-xl md:text-3xl text-blue-400/80 font-light tracking-[0.2em] uppercase">
        ...
        >
          <p className="text-[16px] md:text-[18px] text-white/50 leading-relaxed font-light tracking-wide">
        ...
        >
          <motion.a
            ...
            className="group relative inline-flex items-center justify-center gap-3 px-10 py-5 rounded-full overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.4)]"
          >
            {/* Background & Border */}
            <div className="absolute inset-0 bg-white/[0.05] backdrop-blur-xl rounded-full border border-white/20 group-hover:border-white/40 transition-colors duration-500" />
            ...
            <span className="relative z-10 text-[14px] font-semibold tracking-[0.15em] text-white uppercase mt-0.5 shadow-black/50 drop-shadow-md">
              Explore My Work
            </span>
            <div className="relative z-10 w-8 h-8 flex items-center justify-center rounded-full bg-white/10 group-hover:bg-white/30 transition-colors duration-300">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-[#030303] to-transparent z-30 pointer-events-none" />
    </div>
  );
}
